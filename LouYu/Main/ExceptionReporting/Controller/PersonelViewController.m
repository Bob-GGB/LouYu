...
@interface PersonelViewController ()<UITableViewDelegate,UITableViewDataSource>
...
//                         NSLog(@"dict:%@",dict);
            ...
            [ClearCache showHUDWithText:@"没有组员名单"];
        }
                else{
...
//                                 else{
                                     ...
                                     NSUserDefaults *defaults=[NSUserDefaults standardUserDefaults];
                                     //保存到本地
                                     [defaults setObject:self.Model.userName forKey:@"KUserName"];
                                     [defaults setObject:self.Model.userID forKey:@"KuserID"];
                                     [defaults setObject:self.Model.headImgUrl forKey:@"KheadImgUrl"];
