...
- (void)createSubViews
{
    ...
    if (self.title && self.title.length) {
        ...
        titleLabel.frame = CGRectMake(0, 0, SCREEN_WIDTH-200, titleHeight);
    ...
    for (int i=0; i<self.confirms.count; i++) {
        ...
        confirm.frame = CGRectMake(0, line.frame.origin.y+lineHeight, SCREEN_WIDTH-200, buttonHeight);
        [confirm setTitle:self.confirms[i] forState:UIControlStateNormal];
        confirm.titleLabel.font = [UIFont systemFontOfSize:ZFSize_17];
        [confirm setTitleColor:KRGB(51, 51, 51, 1.0) forState:UIControlStateNormal];
    ...
    cancel.frame = CGRectMake(0, cancelY, SCREEN_WIDTH-200, cancleHeight);
    ...
    self.frame = CGRectMake(100, SCREEN_HEIGHT/3, SCREEN_WIDTH-200, ActionSheetHeight);
}
