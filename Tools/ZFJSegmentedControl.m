...
- (void)initValue{
    ...
    _selectTitleColor = [UIColor whiteColor];//RGB:238 52 9
...
- (void)setFrame:(CGRect)frame{
    ...
    _selectBtnWID = _isSetWID == NO ? (frame.size.width - (_btnCount - 1) * _selectBtnSpace)/2: _selectBtnWID;
...
- (void)refreshUIWithSelectBtn:(UIButton *)button{
    ...
    if(self.SCType == SCType_Underline){
        ...
        [UIView animateWithDuration:_animateDuration animations:^{
            self.stateView.frame = CGRectMake(button.frame.origin.x+_selectBtnWID/4, self.frame.size.height - _SCType_Underline_HEI, _selectBtnWID/2, _SCType_Underline_HEI);
        }];
    }else if(self.SCType == SCType_Dot){
        [UIView animateWithDuration:_animateDuration animations:^{
...
- (void)setSCType_Underline_HEI:(CGFloat)SCType_Underline_HEI{
    ...
    if(self.SCType == SCType_Underline){
        self.stateView.frame = CGRectMake(selectBtn.frame.origin.x+_selectBtnWID/4, self.frame.size.height - _SCType_Underline_HEI, _selectBtnWID/2, _SCType_Underline_HEI);
    }else if(self.SCType == SCType_Dot){
        self.stateView.frame = CGRectMake(selectBtn.frame.origin.x + (_selectBtnWID - _SCType_Underline_HEI)/2, self.frame.size.height - _SCType_Underline_HEI, _SCType_Underline_HEI, _SCType_Underline_HEI);
        self.stateView.layer.cornerRadius = _SCType_Underline_HEI/2;
    }else if(self.SCType == SCType_Ellipse){
